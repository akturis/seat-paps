...
//        $this->addCommands();
    ...
    public function register()
    {
        ...
        $this->mergeConfigFrom(__DIR__ . '/Config/paps.permission.php', 'web.permissions.character');
        $this->mergeConfigFrom(__DIR__ . '/Config/paps.permission.php', 'web.permissions.corporation');
